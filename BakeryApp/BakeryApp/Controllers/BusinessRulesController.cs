...
namespace BakeryApp.Controllers
{
    public class BusinessRulesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BusinessRuleKey,RuleName,RuleDescription")] BusinessRule businessRule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BusinessRuleKey,RuleName,RuleDescription")] BusinessRule businessRule)
        {
            if (ModelState.IsValid)
            {
